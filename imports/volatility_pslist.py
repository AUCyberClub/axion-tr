...
def volatility_pslist():
    ...
    while True:
        ...
        check_call(["clear"])
        print (logo)
        colorprint("info","RAM dump çalışan processleri görüntülemek için 'volatility' tool'u kullanılacaktır.")
        ...
        if err.find("The requested file doesn't exist") != -1:
            ...
            if out.find("No") != -1:
                colorprint("warn", out)
                colorprint("fatal", "RAM Dump dosyası değil. Yeniden başlatılıyor...")
